...
//  Copyright © 2019 Ryze Zeng. All rights reserved.
//

import UIKit
import ObjectiveC.runtime

/// RyzeExtension: the key of runtime, add Properties
private var closureKey: Void?

/// RyzeExtension: self Target
...
public extension UIControl {
    /// RyzeExtension: all ControlClosureTarget  of UIControl.
...
// MARK: - Methods
public extension UIControl {
    /// RyzeExtension: remove all ControlClosureTarget
    ...
    /// RyzeExtension: set target/action for particular event.
    ///
    ...
    /// RyzeExtension: add a closure of target/action
    ///
    /// - Parameters:
    ///   - controlEvents: UIControl.Event
    ...
    /// RyzeExtension: set a closure of target/action
    ///
    ...
    /// RyzeExtension: remove all closure of target/action
    ///
